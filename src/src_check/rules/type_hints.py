...
class TypeHintVisitor(ast.NodeVisitor):
    ...
    def __init__(self, filepath: Path):
        ...
        self.generic_types = {'dict', 'list', 'set', 'tuple', 'Dict', 'List', 'Set', 'Tuple'}
    ...
    def _check_function_type_hints(self, node: Union[ast.FunctionDef, ast.AsyncFunctionDef]) -> None:
    ...
    def _check_generic_types(self, node: Union[ast.FunctionDef, ast.AsyncFunctionDef]) -> None:
        ...
        for arg in node.args.args:
            if arg.annotation:
                self._check_annotation(arg.annotation, node.lineno, f"parameter '{arg.arg}'")
        
        # Check return annotation
        if node.returns:
            self._check_annotation(node.returns, node.lineno, "return type")
    
    def _check_annotation(self, annotation: ast.expr, lineno: int, context: str) -> None:
