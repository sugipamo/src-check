...
from src_check.context.rules import RuleContext, ContextAwareRuleManager
...
class TestContextAwareRuleManager:
    ...
    def test_get_adjusted_threshold(self):
        ...
        adjusted = self.manager.get_adjusted_threshold('complexity', 'cyclomatic', context)
        assert adjusted == 20.0  # 10 * 2.0
        
        # Base cognitive complexity threshold is 15
        adjusted = self.manager.get_adjusted_threshold('complexity', 'cognitive', context)
    ...
    def test_get_rule_explanation(self):
        ...
        assert prod_explanation['context_note'] == 'Production code requires strict quality standards'