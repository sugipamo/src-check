...
class TestFailureLocation:
    ...
    def test_creation(self):
        ...
        loc = FailureLocation(
            file_path="test.py", line=10, column=5, message="Test failure"
        )
...
class TestCheckResult:
    ...
    def test_add_failure(self):
        ...
        result = CheckResult(title="Test Check", checker_name="test_checker")

        result.add_failure(file_path="test.py", line=10, message="Test failure")
...
class TestKPIScore:
    ...
    def test_creation(self):
        ...
        score = KPIScore(total_score=85.0, project_path="/test/project")
...
class TestSrcCheckConfig:
    ...
    def test_from_dict(self):
        ...
        data = {
            "base_score": 90.0,
            "weights": {"code_quality": 0.3, "security_quality": 0.4},
            "rules": [{"name": "test_rule", "enabled": False}],
    ...
    def test_yaml_roundtrip(self, tmp_path):
        ...
        config.rules.append(RuleConfig(name="test_rule", enabled=True))
